              ...
              bcrypt.hash(user.password, 10)
                ...
                .then((hash) => {
                  ...
                  pool.connect((err, client, done) => {
                    ...
                    client.query('INSERT INTO users (id,email, first_name, last_name, password, is_admin) VALUES ($1, $2, $3, $4, $5,$6)', [user.id,user.email, user.first_name, user.last_name, user.password, user.is_admin], (err, result) => {
                      if (err) {
                        console.log(err);
                      }
                      console.log(result.rows);
